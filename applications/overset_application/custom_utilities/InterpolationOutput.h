...
public:
    ...
    virtual void InterpolateDataFromElement( const Point<3> & r_point, const ModelPart::ElementType & r_element )
    {
        ...
        std::size_t num_node = r_geometry.size();
    ...
    /*
        ...
        Matrix DNs_DXs = prod(DNs_DEs, r_point);

        //field variable
        //TEMPERATURE
		Vector nodes_temp = ZeroMatrix(num_node);
        ...
        Vector Dtemp_DXs = prod( transpose( DNs_DXs ), nodes_temp );
    */
