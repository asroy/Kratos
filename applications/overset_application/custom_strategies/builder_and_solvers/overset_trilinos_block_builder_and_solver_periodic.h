...
public:
    ...
    OversetTrilinosBlockBuilderAndSolverPeriodic(Epetra_MpiComm & Comm, int guess_row_size, typename TLinearSolver::Pointer pNewLinearSystemSolver, const Variable<int> & PeriodicIdVar, OversetAssembly::OversetAssembler & r_overset_assembler)
