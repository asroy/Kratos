...
class CheckAndPrepareModelProcess(KratosMultiphysics.Process):
    def __init__(self, main_model_part, Parameters ):
        ...
        self.volume_submodel_part_name_list = Parameters["volume_submodel_parts"]
        self.skin_name_list = Parameters["skin_parts"]
       

    def Execute(self):
        volume_submodel_parts = []
        for i in range(self.volume_submodel_part_name_list.size()):
            volume_submodel_parts.append(self.main_model_part.GetSubModelPart(self.volume_submodel_part_name_list[i].GetString()))
        ...
        for part in volume_submodel_parts:
